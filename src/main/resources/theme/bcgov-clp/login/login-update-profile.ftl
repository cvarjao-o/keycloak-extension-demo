...
<@layout.registrationLayout; section>
    <#if section = "title">
        ${msg("loginProfileTitle")}xxxx
    <#elseif section = "header">
        ${msg("loginProfileTitle")}yyyy
    <#elseif section = "form">
        <form id="kc-update-profile-form" class="${properties.kcFormClass!}" action="${url.loginAction}" method="post">
            ...
            <div class="${properties.kcFormGroupClass!}">
               <div class="${properties.kcLabelWrapperClass!}">
                   <label for="user.attributes.mobile" class="${properties.kcLabelClass!}">Teams</label>
               </div>            
               <div class="${properties.kcInputWrapperClass!}">
                   <input type="text" class="${properties.kcInputClass!}" id="user.attributes.teams" name="user.attributes.teams"/>
               </div>
            </div>
            <div class="${properties.kcFormGroupClass!}">
