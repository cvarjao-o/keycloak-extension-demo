 ...
 */
public class RequireUserRoleAuthenticationFactory implements AuthenticatorFactory {

    public static final String PROVIDER_ID = "cvarjao-idp-create-user-if-unique";
    ...
    public String getDisplayType() {
        return "Create User If Unique (CVARJAO)";
    }
