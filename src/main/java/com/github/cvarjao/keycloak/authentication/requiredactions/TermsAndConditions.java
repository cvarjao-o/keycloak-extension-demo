...
public class TermsAndConditions implements RequiredActionProvider, RequiredActionFactory {
    public static final String PROVIDER_ID = "cvarjao_terms_and_conditions";
    public static final String USER_ATTRIBUTE = PROVIDER_ID;
    public static final String FORM = "cvarjao_terms_and_conditions.ftl";
    ...
    public String getDisplayText() {
        return "Terms and Conditions (CVARJAO)";
    }
